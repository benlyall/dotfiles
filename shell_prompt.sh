...
function __promptline {
  ...
  local a_fg="${wrap}38;5;230${end_wrap}"
  local a_bg="${wrap}48;5;32${end_wrap}"
  local a_sep_fg="${wrap}38;5;32${end_wrap}"
  local b_fg="${wrap}38;5;230${end_wrap}"
  local b_bg="${wrap}48;5;241${end_wrap}"
  local b_sep_fg="${wrap}38;5;241${end_wrap}"
  local warn_fg="${wrap}38;5;24${end_wrap}"
  local warn_bg="${wrap}48;5;136${end_wrap}"
  local warn_sep_fg="${wrap}38;5;136${end_wrap}"
  local x_fg="${wrap}38;5;109${end_wrap}"
  local x_bg="${wrap}48;5;24${end_wrap}"
  local x_sep_fg="${wrap}38;5;24${end_wrap}"
  local y_fg="${wrap}38;5;109${end_wrap}"
  local y_bg="${wrap}48;5;241${end_wrap}"
  local y_sep_fg="${wrap}38;5;241${end_wrap}"
  local z_fg="${wrap}38;5;24${end_wrap}"
  local z_bg="${wrap}48;5;102${end_wrap}"
  local z_sep_fg="${wrap}38;5;102${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
